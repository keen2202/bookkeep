...
| M1 P0 功能完成 | 2026-09-04 | BK-T-002~008 | 6 个 P0 Spec 验证标准全过；单测覆盖率 ≥ 80% | completed（2026-08-01，app 84.1%/server 91.89%） |
| M2 P0 验收 / Alpha | 2026-09-11 | BK-T-009 | 核心路径回归通过；性能预算达标；Alpha 内测包发布 | blocked（本地验收与黄金路径 e2e 通过；Alpha 发布与设备端安全验证待 CI/真机） |
| M3 P1 功能完成 | 2026-10-16 | BK-T-010~015 | 6 个 P1 Spec 验证标准全过；权限/安全用例全过 | completed（2026-08-02，app 242 测试/服务端 55 测试全过） |
