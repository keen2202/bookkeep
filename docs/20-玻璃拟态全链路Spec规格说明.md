> ⚠️ **已废弃（2026-08-24）**：本文档由 FGDS v1.0 iOS 毛玻璃体系完全取代——
> 设计见 `docs/22-iOS毛玻璃设计文档.md`、参数唯一源见 `docs/23-iOS毛玻璃Spec规格说明.md`、
> 实施拆解见 `docs/24-iOS毛玻璃任务分解.md`。保留存档不删除（Spec §8 清除要求）。
